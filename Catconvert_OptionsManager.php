...
class Catconvert_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'catconvert'));
        }
        ...
        ?>
        <div class="wrap">
            <h2>Catconvert Wordpress Plugin</h2>
            <table class="form-table">
                <tbody>
                    <tr>
                        This plugin adds a link under the youtube video's which allows your visitors to convert your video's to mp3 file.
                        The link that's injected under the video's has the following html definition a 'div' container with 'a' element, for example:
                        <br/>
                        <br/>
                        <strong>
                            <?php echo htmlspecialchars("<div class=\"catconvert-default-container\"> <a href=\"http://www.catconvert.com/en/?url=a youtube link\" target=\"_blank\" class=\"catconvert-default-btn\">Youtube to mp3</a> </div>") ?>
                        </strong>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'catconvert'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'catconvert') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'catconvert');
            case 'false':
                return __('false', 'catconvert');

            case 'Administrator':
                return __('Administrator', 'catconvert');
            case 'Editor':
                return __('Editor', 'catconvert');
            case 'Author':
                return __('Author', 'catconvert');
            case 'Contributor':
                return __('Contributor', 'catconvert');
            case 'Subscriber':
                return __('Subscriber', 'catconvert');
            case 'Anyone':
                return __('Anyone', 'catconvert');
        }
        return $optionValue;
    }
